...
- 理由：画像全体をイチから描き直すより，元の画像との差分である「直前で足されたノイズの模様」だけを見つけ出して予測する方が，ニューラルネットワークにとってタスクが圧倒的に簡単であり，生成品質も劇的に向上するため．U-Netのスキップ接続をフル活用して元画像を高画質のまま出力側へ流し，ノイズの差分だけを畳み込み層で学習しようねというお話．
